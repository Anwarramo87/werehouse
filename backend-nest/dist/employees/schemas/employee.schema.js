...
__decorate([
    (0, mongoose_1.Prop)({ required: true, unique: true, match: /^EMP[0-9]{3,}$/ }),
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Employee.prototype, "scheduledStart", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Employee.prototype, "scheduledEnd", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: 'Warehouse' }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ default: 'active', enum: ['active', 'inactive', 'on_leave', 'terminated'] }),
    __metadata("design:type", String)
