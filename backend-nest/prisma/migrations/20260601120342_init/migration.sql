...
-- CreateIndex
CREATE INDEX "employees_terminationDate_idx" ON "employees"("terminationDate");

-- CreateIndex
CREATE INDEX "employees_terminationType_idx" ON "employees"("terminationType");

-- CreateIndex
CREATE INDEX "employees_financialSettlementStatus_idx" ON "employees"("financialSettlementStatus");

-- CreateIndex
CREATE INDEX "employees_status_terminationDate_idx" ON "employees"("status", "terminationDate");

-- CreateIndex
CREATE INDEX "employees_financialSettlementStatus_financialSettlementDate_idx" ON "employees"("financialSettlementStatus", "financialSettlementDate");
